                    ...
                    <form method="POST" action="{{ route('clients.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="contact_email" name="contact_email" type="email"
                                class="block mt-1 w-full" :value="old('contact_email')" required autocomplete="contact_email" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="contact_phone_number" name="contact_phone_number" type="text"
                                class="block mt-1 w-full" :value="old('contact_phone_number')" required autocomplete="tel" />
